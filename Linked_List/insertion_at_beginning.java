...
public class insertion_at_beginning {
    ...
    public void middleNode()
    {
        ...
        System.out.println("Midlle data of a  given linked list is "+slow.data);
    }
    ...
    public void detectLoop(){
        ...
        if(flag == 0)
        {
            ...
            System.out.println("Loop is detetcted");
        }
    }
...
//implementation of deletion of a node in a linkedlist
 void deleteNode(int position){
    ...
    public static void main(String[] args){
        insertion_at_beginning llist = new insertion_at_beginning();
